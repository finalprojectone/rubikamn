...
TMP_FOLDER="tmp"
CONFIG_FILE='rubika.conf'
CONFIGFOLDER='/root/.rubika'
COIN_DAEMON='rubikad'
COIN_CLI='rubika-cli'
COIN_PATH='/usr/local/bin/'
KERN_ARCH=$(uname -m)
COIN_RELEASE='https://api.github.com/repos/finalprojectone/rubika/releases/latest'
COIN_NAME='RubikaCoin'
COIN_PORT=36547
RPC_PORT=36557
...
port=$COIN_PORT
testnet=0
addnode=79.137.112.174:36547
addnode=51.254.242.241:36547
addnode=140.82.44.222
addnode=207.148.26.38
addnode=149.28.235.5
EOF
}
